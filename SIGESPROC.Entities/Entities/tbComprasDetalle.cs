...
namespace SIGESPROC.Entities.Entities
{
    ...
    {
        public tbComprasDetalle()
        {
            tbComprasDetallesDirecciones = new HashSet<tbComprasDetallesDirecciones>();
        ...
        public virtual tbCotizacionesDetalle code { get; set; }
        public virtual tbComprasEncabezado coen { get; set; }
        public virtual tbUsuarios usua_CreacionNavigation { get; set; }
        public virtual tbUsuarios usua_ModificacionNavigation { get; set; }
        public virtual ICollection<tbComprasDetallesDirecciones> tbComprasDetallesDirecciones { get; set; }
